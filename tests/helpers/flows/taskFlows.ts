...
/**
 * Creates a task via the UI from the Admin tab:
 * Admin -> open dialog -> fill form -> pick map coords -> submit -> wait for API -> ensure closed
 */
export async function createTaskFromAdmin(
  page: Page,
  navBar: NavBar,
  task: BasicTaskData,
  timeoutMs = 60_000
